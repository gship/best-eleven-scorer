            ...
            body: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      padding: WidgetStatePropertyAll(EdgeInsets.fromLTRB(40, 17, 40, 18.5)),
                      shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(32.0))),
